...
| :------ | :----------- |:-----------------------------|:-----------------------------------------------------------------------------| :---------- |
| /live/test | | 'ok'                         | Display a confirmation message in Live, and sends an OSC reply to /live/test | :heavy_check_mark: |
| /live/application/get/version | | major_version, minor_version | Query Live's version                                                         | :heavy_check_mark: |
